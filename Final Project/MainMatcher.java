...
public class MainMatcher {
    ...
    public static void main(String[] args) {
        ...
        Map<String,String> patientFiles = Map.of("Patient1", "sample_patient_anno_input_1.ann,R2", 
                                                 "Patient2", "sample_patient_anno_input_2.ann,T1");
        Map<String,String> clinicalTrialFiles = Map.of("Trial1", "sample_ct_anno_input_1.ann,O1", 
                                                       "Trial2", "sample_ct_anno_input_2.ann,O1");
